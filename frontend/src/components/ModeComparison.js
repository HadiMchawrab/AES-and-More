...
const modes = [
  ...
  {
    name: 'CFB-128',
    full: 'Cipher Feedback (s = 128)',
    iv: 'Zero IV',
    chaining: 'Encrypt prev ciphertext block',
    parallel: 'Decrypt only',
    type: 'Stream (block-sized)',
    encOnly: 'Yes',
    errorProp: 'Current + next block',
  ...
  {
    name: 'CFB-8',
    full: 'Cipher Feedback (s = 8)',
    iv: 'Zero IV',
    chaining: 'Shift register: drop top byte, append C byte',
    parallel: 'Decrypt only',
    type: 'Stream (byte-oriented)',
    encOnly: 'Yes',
    errorProp: 'Up to ⌈b/s⌉ + 1 = 17 bytes',
    security: '16× more AES calls per byte — slow but self-synchronising',
  },
  {
    name: 'OFB',
